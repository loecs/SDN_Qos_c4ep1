...
ETHERNET_MULTICAST = ["ff:ff:ff:ff:ff:ff","01:00:5e:00:00:fb","01:00:5e:00:00:16"]
...
class ARP_PROXY_13(app_manager.RyuApp):
    ...
    def add_flow(self, datapath, priority, match, actions, buffer_id=None):
        ...
        inst = [parser.OFPInstructionActions(ofproto.OFPIT_APPLY_ACTIONS,
                                             actions)]
        if buffer_id:
            mod = parser.OFPFlowMod(datapath=datapath, buffer_id=buffer_id, idle_timeout=60,
                                    hard_timeout=300, priority=priority, match=match,
                                    instructions=inst)
        else:
    ...
    def arp_handler(self, header_list, datapath, in_port, msg_buffer_id):
        ...
        if eth_dst in ETHERNET_MULTICAST and ARP in header_list:
