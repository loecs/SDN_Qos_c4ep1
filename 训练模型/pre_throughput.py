...
def throughput():
    ...
    throughput_vllues = prediction_real_change
    return throughput_vllues
# a=throughput()
# print(a)

#保存数据
# data3=pd.DataFrame()
# data3['predicted_vlues']=prediction_real_change
# data3.to_excel('pre_throughput.xlsx')
# print(type(prediction_real_change))
